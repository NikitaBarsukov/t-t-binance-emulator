...
public class AdminExchangeInfoHolderController {

  private final ExchangeInfoHolderService service;

    @ApiOperation(value = "Creates an order. If the WS is open puts it in there by listenkey.")
    @GetMapping()
    public List<ExchangeInfoHolderDto> getIncome(@RequestHeader("X-MBX-APIKEY") String apiKey,
